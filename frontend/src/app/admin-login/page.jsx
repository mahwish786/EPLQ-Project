      ...
      <div className="flex-grow flex items-center justify-center p-4">
        <div className="bg-white w-full max-w-md p-6 md:p-10 rounded-2xl shadow-2xl border border-slate-100 mx-4">
          <div className="text-center mb-8">
            ...
            <p className="text-slate-500 mt-2">Manage secure location data</p>
          </div>
          ...
          <div className="mt-8 pt-6 border-t border-slate-100 flex flex-col gap-3 text-center">
            ...
            <div className="text-sm text-slate-600">
              ...
              <Link href="/admin-signup" className="font-bold text-blue-600 hover:text-blue-800 underline decoration-2 underline-offset-2">
                Create Account
              </Link>
            </div>
          </div>
