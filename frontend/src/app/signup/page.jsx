      ...
      <div className="flex-grow flex items-center justify-center p-4">
        <div className="bg-white w-full max-w-md p-6 md:p-10 rounded-2xl shadow-2xl border border-slate-100 mx-4">
          <div className="text-center mb-8">
            ...
            <p className="text-slate-500 mt-2">Join the secure location network</p>
          </div>
          ...
          <div className="mt-6 pt-6 border-t border-slate-100 text-center">
            <div className="text-sm text-slate-600">
              ...
              <Link href="/login" className="font-bold text-blue-600 hover:text-blue-800 underline decoration-2 underline-offset-2">
                Sign In here
              </Link>
            </div>
          </div>
